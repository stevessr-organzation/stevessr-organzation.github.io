...
// 根据自己的情况进行配置
const config = {
    username: "stevessr-organzation", // GitHub 用户名
	teamname: "stevessr-organzation",
    token: "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",  // GitHub Token
    repo: "stevessr-organzation.github.io",  // 存放 issues的git仓库
