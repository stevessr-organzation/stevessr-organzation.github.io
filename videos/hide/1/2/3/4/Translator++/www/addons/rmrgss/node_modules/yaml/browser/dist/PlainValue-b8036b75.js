...
function _inherits(subClass, superClass) {
  if (typeof superClass !== "function" && superClass !== null) {
    throw new TypeError("超级表达式必须为null或函数");
  }
...
function _assertThisInitialized(self) {
  if (self === void 0) {
    throw new ReferenceError("这还没有初始化-super（）还没有被调用");
  }
...
function _nonIterableRest() {
  throw new TypeError("试图对不可重写实例进行分解的尝试无效。\n为了实现可移植性，非数组对象必须具有[Symbol.iterator]（）方法。");
}
...
function _createForOfIteratorHelper(o, allowArrayLike) {
  ...
  if (typeof Symbol === "undefined" || o[Symbol.iterator] == null) {
    ...
    throw new TypeError("迭代不可迭代实例的尝试无效。\n为了是可编辑的，非数组对象必须有[Symbol.iterator]（）方法。");
  }
...
var YAMLError = /*#__PURE__*/function (_Error) {
  ...
  function YAMLError(name, source, message) {
    ...
    if (!message || !(source instanceof Node)) throw new Error("参数无效".concat(name));
  ...
  _createClass(PlainValue, [{
    ...
    get: function get() {
      ...
      switch (ch0) {
        ...
        case '`':
          {
            var _msg = "普通值不能以保留字符开头".concat(ch0);
