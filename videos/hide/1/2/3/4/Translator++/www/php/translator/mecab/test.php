...
$REP = array(
	...
	foreach ($lines as $key=>$line) {
		...
		$ELM['romaji'] = trim($ELM['romaji']);
		/*
		$currentEncoding =  mb_detect_encoding($ELM['romaji'], "JIS, eucjp-win, sjis-win, UTF-8");
		$ELM['romaji'] = mb_convert_encoding($ELM['romaji'], "UTF-8", $currentEncoding);
		*/
