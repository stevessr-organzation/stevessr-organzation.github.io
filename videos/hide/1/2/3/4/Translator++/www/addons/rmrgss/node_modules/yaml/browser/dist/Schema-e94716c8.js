...
json.scalarFallback = function (str) {
  throw new SyntaxError("未解析纯标量".concat(JSON.stringify(str)));
};
...
function findTagObject(value, tagName, tags) {
  if (tagName) {
    ...
    if (!tagObj) throw new Error("标签".concat(tagName, "找不到"));
    return tagObj;
...
function getSchemaTags(schemas, knownTags, customTags, schemaId) {
  ...
  if (!tags) {
    ...
    throw new Error("未知模式 \"".concat(schemaId, "\"; 使用其中一个").concat(keys));
  }
  ...
  for (var i = 0; i < tags.length; ++i) {
    ...
    if (typeof _tag === 'string') {
      ...
      if (!tagObj) {
        ...
        throw new Error("未知自定义标记 \"".concat(_tag, "\"; 使用其中一个").concat(_keys));
      }
