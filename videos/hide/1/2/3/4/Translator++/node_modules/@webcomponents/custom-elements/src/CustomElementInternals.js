...
export default class CustomElementInternals {
    ...
    patchAndUpgradeTree(root, options = {}) {
        ...
        const gatherElements = (element) => {
            ...
            if (element.localName === 'link' &&
                ...
                if (importNode &&
                    importNode.readyState === 'complete') {
    ...
    upgradeReaction(element) {
        try {
            const definition = this._lookupACustomElementDefinition(element.ownerDocument, element.localName);
            if (definition) {
    ...
    reportTheException(error) {
        ...
        if (ErrorEvent.prototype.initErrorEvent === undefined) {
            event = new ErrorEvent('error', { cancelable: true, message, filename, lineno, colno, error });
        }
        else {
