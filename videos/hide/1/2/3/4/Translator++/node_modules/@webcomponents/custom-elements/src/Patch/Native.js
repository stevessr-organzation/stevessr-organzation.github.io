...
export const Document_createElementNS = window.Document.prototype.createElementNS;
...
export const DocumentFragment_prepend = window.DocumentFragment.prototype['prepend'];
export const DocumentFragment_append = window.DocumentFragment.prototype['append'];
...
export const Node_textContent = Object.getOwnPropertyDescriptor(window.Node.prototype, 'textContent');
export const Element_attachShadow = window.Element.prototype['attachShadow'];
export const Element_innerHTML = Object.getOwnPropertyDescriptor(window.Element.prototype, 'innerHTML');
...
export const Element_removeAttributeNS = window.Element.prototype.removeAttributeNS;
export const Element_insertAdjacentElement = window.Element.prototype['insertAdjacentElement'];
export const Element_insertAdjacentHTML = window.Element.prototype['insertAdjacentHTML'];
...
export const HTMLElement_innerHTML = Object.getOwnPropertyDescriptor(window.HTMLElement.prototype, 'innerHTML');
export const HTMLElement_insertAdjacentElement = window.HTMLElement.prototype['insertAdjacentElement'];
export const HTMLElement_insertAdjacentHTML = window.HTMLElement.prototype['insertAdjacentHTML'];