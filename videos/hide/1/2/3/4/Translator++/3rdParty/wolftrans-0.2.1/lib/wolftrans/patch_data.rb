  ...
  class Patch
    def load_data(game_dir)
      ...
      map_names.each do |name|
        ...
        puts "registering map name #{name} \n"
      ...
      @assets.keys.sort.each do |fn|
        ...
        #puts "registering assets name #{fn} \n"
    ...
    def apply(out_dir)
      ...
      #TODO create directories for each asset
		#donovan addition
		mapDir = "#{out_data_dir}/MapData"
		puts "Creating folder at :  #{mapDir} \n"
		FileUtils.mkdir_p(mapDir)
      ...
      @maps.each do |map_name, map|
        ...
        puts "Map full path :  #{fullpath} \n"
        map.dump(fullpath)
		
		#donovan addition
        fullpath2 = "#{mapDir}/#{map_name}.mps"
        #fullpath2 = "#{out_data_dir}/MapData/#{map_name}.mps"
		#dirname = File.dirname(fullpath2)
		#unless File.directory?(dirname)
		#  puts "Creating folder at :  #{dirname} \n"
		#  FileUtils.mkdir_p(dirname)
		#end
        puts "Corrected Map full path :  #{fullpath2} \n"
        map.dump(fullpath2)
